...
class PersistHandling {
    ...
    public func AddRecord(_ title:String!, publisher:String!, author:String!) -> Bool {
    ...
    public func getRecords() -> [(title:String, publisher:String, author:String)] {
        ...
        do {
            ...
            for data in result as! [NSManagedObject] {
                ...
                books.append((title,publisher, author))
            }
